...
const AlertBar = () => {
  ...
  return (
    <div className={`flex justify-between fixed top-20 w-full left-1/2 transform -translate-x-1/2 z-50 py-4 px-6 rounded ${alertClasses[type]} ${textColor}`}>
      ...
      <div className="flex items-center">
        <button
          onClick={handleClick}
          className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-300 transition-colors"
        >
          Comprar licencia
        </button>
